# DevOps & SRE Blueprint Plan (Legacy, 2025-10-08)

This file preserves the original long-form DevOps/SRE blueprint plan that existed before the repo pivoted to a guardrails-first, AI-in-SRE course direction.
...
- ⚠️ SBOM generation (Syft/Grype - pending)
